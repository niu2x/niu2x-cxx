...
lua_Hook lua_gethook(lua_State* L) { return L->hook; }

int lua_gethookmask(lua_State* L) { return L->hookmask; }
...
static int precheck(const Proto* pt)
{
    ...
    check(
        !(pt->is_vararg & VARARG_NEEDSARG) || (pt->is_vararg & VARARG_HASARG));
...
static const char* getobjname(
    lua_State* L, CallInfo* ci, int stackpos, const char** name)
{
